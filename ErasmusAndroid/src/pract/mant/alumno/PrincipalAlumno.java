 ...
 * acceder a sus destinos disponibles de la beca Erasmus.
 * 
 * @author Betanzos
 * 
 */
...
public class PrincipalAlumno extends Activity {
	...
	/**
	 * Una vez que se pulsa el botón volver se vuelve a la actividad principal
	 * 
	 * @param v
	 *            Botón que lanza el evento
	 */
	...
	/**
	 * Se accede a la actividad DestinoAlumnoActivity en la cual se listan los
	 * destinos disponibles para un alumno.
	 * 
	 * @param v
	 *            Botón que lanza el evento
	 */
	...
	/**
	 * Envía al usuario a la pantalla para elegir las asignaturas de las que
	 * está matriculado
	 * 
	 * @param v
	 *            Botón que lanza el evento
